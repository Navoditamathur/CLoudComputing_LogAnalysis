...
if __name__ == '__main__':
    ...
    b_root = blockchain.get_merkle_root()
    if query_client.query_verification("k1", k1_query_value, k1_proofs, b_root):
    ...
    b_root = blockchain.get_merkle_root()
    if query_client.query_verification("k1", k1_query_value_m, k1_proofs, b_root):
        print("Retrived value is verified")
    else:
        print("Retrived value is modified")
